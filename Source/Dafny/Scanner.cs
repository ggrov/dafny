...
//      if (ch == EOL) { line++; col = 0; }
  ...
  public void CheckLiteral() {
		switch (t.val) {
			...
			case "tactic": t.kind = 87; break;
			case "inline": t.kind = 88; break;
			...
			case "tvar": t.kind = 117; break;
			case "tmatch": t.kind = 118; break;
			case "tassert": t.kind = 119; break;
			case "try": t.kind = 121; break;
			case "catch": t.kind = 122; break;
			case "where": t.kind = 123; break;
			case "return": t.kind = 124; break;
			case "if": t.kind = 125; break;
			case "while": t.kind = 126; break;
			case "print": t.kind = 127; break;
			case "parallel": t.kind = 128; break;
			case "modify": t.kind = 129; break;
			case "exists": t.kind = 146; break;
			case "vars": t.kind = 152; break;
			case "input": t.kind = 153; break;
			case "lemmas": t.kind = 154; break;
			case "false": t.kind = 155; break;
			case "true": t.kind = 156; break;
			case "null": t.kind = 157; break;
			case "this": t.kind = 158; break;
			case "fresh": t.kind = 159; break;
			case "allocated": t.kind = 160; break;
			case "unchanged": t.kind = 161; break;
			case "old": t.kind = 163; break;
			default: break;
		}
  }
